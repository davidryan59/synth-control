...
console.log('');
console.log('');
console.log(chalk.cyan("new SynthControlMessage({ param: 'gain', duration: 0.05, value: -0.352 }).setTimeStart(42)"));
console.log(chalk.yellow(`${arr[2] = new SynthControlMessage({ param: 'gain', duration: 0.05, value: -0.352 }).setTimeStart(42)}`));
console.log(arr[2]);
console.log('');
console.log('');
