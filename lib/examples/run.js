...
console.log(chalk.yellow(`${arr[1] = new SynthControlMessage({ p: 'freq', l: 4, v: 440 })}`));
console.log(arr[1]);
console.log('');
console.log('');
console.log(chalk.cyan("new SynthControlMessage({ param: 'gain', length: 0.05, value: -0.352 }).setStartTime(42)"));
console.log(chalk.yellow(`${arr[2] = new SynthControlMessage({ param: 'gain', length: 0.05, value: -0.352 }).setStartTime(42)}`));
console.log(arr[2]);
console.log('');
console.log('');
...
console.log(chalk.cyan(`new SynthControlArray([
  'invalid item',
  { invalid: 'object' },
  { param: 'delay', length: 48, value: 0.00523, extraKey: 'hello world' },
  { param: 'freq', length: 4, start: 330, end: 400 },
  { p: 'freq', l: 2, v: 440 },
  { p: 'freq', l: 3, v: 551 },
  { p: 'freq', l: 7, v: 549 },
])`));
