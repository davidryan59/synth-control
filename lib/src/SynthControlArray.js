...
class SynthControlArray {
  ...
  get isStructureCached() { return Number.isFinite(this.c.dm); }

  get isTimeSet() { return Number.isFinite(this.c.ts); }

  get timeStart() { return this.isTimeSet ? this.c.ts : 0; }

  get timeEnd() { return this.isTimeSet ? this.c.te : this.duration; }

  get duration() { this.checkStructureCached(); return this.c.dm; }

  get params() { this.checkStructureCached(); return this.c.pa; }

  get durationsByParam() { this.checkStructureCached(); return this.c.ds; }

  get initialValuesByParam() { this.checkStructureCached(); return this.c.iv; }

  get messagesByParam() { this.checkStructureCached(); return this.c.mp; }
  ...
  setTimeStart(tStart, tMult = 1) {
    if (Number.isFinite(tStart) && Number.isFinite(tMult) && tMult > 0) {
      ...
      this.c.ts = tStart;
      this.c.te = tStart + tMult * this.c.dm;
    }
    return this;
  }
