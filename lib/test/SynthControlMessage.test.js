...
describe('Test SCM constructed with decimal duration and value', () => {
  ...
  test('', () => { expect(tf.scm2.setStartTime(-1 / 23).toString()).toEqual("SynthControlMessage: param 'gain', time -0.043478 to 1.6352004 (duration 1.6786787), value -0.567568"); });
...
describe('Test SCM constructed with valid data, thorough test', () => {
  ...
  test('', () => { expect(tf.scm3.setStartTime(39).isTimeSet).toEqual(true); });
  test('', () => { expect(tf.scm3.setStartTime(39).timeStart).toEqual(39); });
  test('', () => { expect(tf.scm3.setStartTime(39).timeEnd).toEqual(43); });
  test('', () => { expect(tf.scm3.setStartTime(39).toString()).toEqual("SynthControlMessage: param 'delay', time 39 to 43 (duration 4), values 0.0345 to 0.0678"); });
  // Timing edge case
  test('setStartTime only accepts numbers', () => { expect(tf.scm3.setStartTime('not a number').isTimeSet).toEqual(false); });
  // Test .map
  test('', () => {
    expect(tf.scm3.map(
