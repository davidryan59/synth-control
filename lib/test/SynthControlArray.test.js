...
// describe('Test SCA constructed with 9 data items', () => {
//   const tf = {};
//   beforeEach(() => {
...
// test('.', () => {
//   tf.sca9.cacheStructure();
//   console.log(tf.sca9);
//   console.log(tf.sca9.c);
//   console.log(tf.sca9.c.map);
//   console.log(tf.sca9.c.map.f1);
//   tf.sca9.setStartTime(42);
//   console.log(tf.sca9);
//   console.log(tf.sca9.c);
//   console.log(tf.sca9.c.map);
//   console.log(tf.sca9.c.map.f1);
//   // tf.sca9.setStartTime(41.7890023)
//   // console.log(tf.sca9)
//   // console.log(tf.sca9.c)
//   // console.log(tf.sca9.c.map)
//   // console.log(tf.sca9.c.map.f1)
//
//   // console.log(tf.sca9.array[0])
//   // console.log(tf.sca9.array[1])
//   // console.log(tf.sca9.array[2])
//   // console.log(tf.sca9.array[3])
//   // console.log(tf.sca9.array[4])
//   // console.log(`${tf.sca9.array[4]}`)
//   // console.log(tf.sca9.array[5])
//   // expect(mapSca).toEqual()
// });
