...
describe('Test thoroughly an SCA constructed with 3 data items', () => {
  ...
  test('Change a value for two parameters only', () => {
    ...
    expect(mapSca.get(0).valueEnd).toEqual(275 + 29);
  ...
  test('Combine two maps using array', () => {
    ...
    expect(mapSca.get(0).valueEnd).toEqual(275);
...
describe('Test caching and timing on SCA constructed with 9 data items', () => {
  ...
  // New SCA
  test('', () => expect(tf.sca9.isStructureCached).toBeFalsy());
  test('', () => expect(tf.sca9.isTimeSet).toBeFalsy());
  test('', () => expect(tf.sca9.timeStart).toEqual(0));
  test('', () => expect(tf.sca9.timeEnd).toEqual(21));
  ...
  test('', () => expect(tf.sca9.initialValuesByParam.f1).toEqual(420));
  test('', () => expect(tf.sca9.initialValuesByParam.f2).toEqual(430));
  test('', () => expect(tf.sca9.initialValuesByParam.f3).toEqual(440));
  ...
  test('', () => expect(tf.sca9.checkStructureCached()).toBe(tf.sca9));
  test('', () => expect(tf.sca9.checkStructureCached().isStructureCached).toBeTruthy());
  test('', () => expect(tf.sca9.checkStructureCached().isTimeSet).toBeFalsy());
  // SCA after invalid setTimeStart call
  test('', () => expect(tf.sca9.setTimeStart()).toBe(tf.sca9));
  test('', () => expect(tf.sca9.setTimeStart().isStructureCached).toBeFalsy());
  test('', () => expect(tf.sca9.setTimeStart().isTimeSet).toBeFalsy());
  // SCA after valid setTimeStart call
  test('', () => expect(tf.sca9.setTimeStart(-13)).toBe(tf.sca9));
  test('', () => expect(tf.sca9.setTimeStart(-13).isStructureCached).toBeTruthy());
  test('', () => expect(tf.sca9.setTimeStart(-13).isTimeSet).toBeTruthy());
  test('', () => expect(tf.sca9.setTimeStart(-13).duration).toEqual(21));
  test('', () => expect(tf.sca9.setTimeStart(-13).timeStart).toEqual(-13));
  test('', () => expect(tf.sca9.setTimeStart(-13).timeEnd).toEqual(8));
  // Check can set time twice, and 2nd change is retained
  test('', () => expect(tf.sca9.setTimeStart(-13).setTimeStart(352.43002)).toBe(tf.sca9));
  test('', () => expect(tf.sca9.setTimeStart(-13).setTimeStart(352.43002).isStructureCached).toBeTruthy());
  test('', () => expect(tf.sca9.setTimeStart(-13).setTimeStart(352.43002).isTimeSet).toBeTruthy());
  test('', () => expect(tf.sca9.setTimeStart(-13).setTimeStart(352.43002).duration).toEqual(21));
  test('', () => expect(tf.sca9.setTimeStart(-13).setTimeStart(352.43002).timeStart).toEqual(352.43002));
  test('', () => expect(tf.sca9.setTimeStart(-13).setTimeStart(352.43002).timeEnd).toEqual(373.43002));
});
